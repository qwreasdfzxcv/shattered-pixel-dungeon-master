...
public class Summoned_brightning extends Buff {
    ...
    public void fx(boolean on) {
        if (on) {
            ...
            target.sprite.add(CharSprite.State.SUMMONED_BRIGHTNING); }
        else {
            target.sprite.remove(CharSprite.State.ILLUMINATED);
            target.sprite.remove(CharSprite.State.SUMMONED_BRIGHTNING); }
    }
