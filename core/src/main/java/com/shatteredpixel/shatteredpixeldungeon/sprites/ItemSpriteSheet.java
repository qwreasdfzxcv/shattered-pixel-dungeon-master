...
public class ItemSpriteSheet {
	...
	public static final int BIBLE           = SINGLE_USE+2;
	...
	public static final int DAMAGED_SHIELD  = WEP_TIER1+3;
	public static final int DAGGER          = WEP_TIER1+4;
	public static final int MAGES_STAFF     = WEP_TIER1+5;
	static{
		assignItemRect(WORN_SHORTSWORD, 13, 13);
		assignItemRect(GLOVES,          12, 16);
		assignItemRect(DAMAGED_SHIELD,  16, 16);
	...
	public static final int BREW_FRIGID		= BREWS+4;
	public static final int BREW_FROSTFIRE	= BREWS+5;
	public static final int BREW_WICKED		= BREWS+6;
	...
	public static final int WILD_ENERGY		= SPELLS+10;
